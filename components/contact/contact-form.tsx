...
export default function ContactForm() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h3 className="text-2xl font-semibold text-fg-text mb-2">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Name Field */}
          <div>
            <label htmlFor="name" className="block text-sm font-medium text-fg-text mb-2">
              Name *
            </label>
            <input
              type="text"
          ...
          {/* Email Field */}
          <div>
            <label htmlFor="email" className="block text-sm font-medium text-fg-text mb-2">
              Email *
            </label>
            <input
              type="email"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Company Field */}
          <div>
            <label htmlFor="company" className="block text-sm font-medium text-fg-text mb-2">
              Company
            </label>
            <input
              type="text"
          ...
          {/* Budget Field */}
          <div>
            <label htmlFor="budget" className="block text-sm font-medium text-fg-text mb-2">
              Budget Range
            </label>
            <select
              id="budget"
        ...
        {/* Project Description */}
        <div>
          <label htmlFor="project" className="block text-sm font-medium text-fg-text mb-2">
            Project Description *
          </label>
          <textarea
            id="project"
