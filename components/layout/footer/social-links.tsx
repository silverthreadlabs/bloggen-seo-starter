  ...
  return (
    <div className="flex space-x-2">
      <SocialLink
        ...
        icon={<FaGithub size={16} className="group-hover:text-fg-text-contrast transition-colors duration-200" />}
      />

      <SocialLink
        href="https://www.linkedin.com/company/106311628/admin/dashboard/"
        ariaLabel="Connect with SilverThread Labs on LinkedIn"
        icon={<FaLinkedinIn size={16} className="group-hover:text-fg-text-contrast transition-colors duration-200" />}
      />
      ...
      <SocialLink
        ...
        icon={<SilverthreadLabsLogo className="group-hover:text-fg-text-contrast transition-colors duration-200" />}
      />
    </div>
  );
};
