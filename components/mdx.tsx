...
function RoundedImage(props: ImageProps) {
  const width = typeof props.width === "string" ? parseInt(props.width) : props.width || 0;
  const height = typeof props.height === "string" ? parseInt(props.height) : props.height || 0;
...
export function CustomMDX(props: MDXRemoteSerializeResult) {
  return <MDXRemote source={""} {...props} components={{ ...components }} />;
}
